...
# will be used in login_for_access_token (jwt)
...
# will be used in login_for_access_token
...
async def get_current_user(token: Annotated[str, Depends(oauth2_bearer)]):
    try:
        ...
        username: str = payload.get("sub")  # sub is the key for username. see above
...
async def create_user(db: db_dependency, create_user_request: CreateUserRequest):
    ...
    # todo_model = Todos(**todo_request.dict()) as before
    # because some names are different (password vs hashed_password)
